...
import com.josafa.cursomc.domain.Cidade;
...
import com.josafa.cursomc.domain.Produto;
import com.josafa.cursomc.domain.enums.EstadoPagamento;
import com.josafa.cursomc.domain.enums.TipoCliente;
import com.josafa.cursomc.repositories.CategoriaRepository;
import com.josafa.cursomc.repositories.CidadeRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("79991268620", "7991251692"));
